...
<html>
    ...
    <body>
        ...
        <div class="select mt-5">
            <?php
                echo'<h2 class="h2 text-center">Your Completed Rides With Us Till Now</h2>';
                ...
                $query = mysqli_query($dbConnect->connect, "SELECT * FROM tbl_ride WHERE user_id = '$x' AND status = '2'");
