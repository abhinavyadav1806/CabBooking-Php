...
<html>
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<?php
				...
				echo "<p id='page-intro'>Showing All Completed Rides.</p>"
			?>
						...
						<table>
							...
							<tbody>
								<?php 
									...
									echo "<form>";
										$query = mysqli_query($dbConnect->connect, "SELECT * FROM tbl_ride WHERE status = 2");
										while($row = mysqli_fetch_array($query))
										{
											echo "<tr>";
												...
												echo ($row['status']==2)?('<td>Completed</td>'):('<td>....</td>');
